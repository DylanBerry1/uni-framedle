...
def main() -> None:
    ...
    while guess_startup != move_choice.startup and guess_adv_min != target_guess_min and guess_adv_max != target_guess_max:
        ...
        print(f"Recap: You guessed that the startup of {move_choice.chara}'s {move_choice.input} is {guess_startup}, and that the advantage is ")